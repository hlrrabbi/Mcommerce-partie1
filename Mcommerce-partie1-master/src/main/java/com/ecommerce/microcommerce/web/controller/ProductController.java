...
public class ProductController {
    ...
    @GetMapping( value = "/Produits/tricroissant" )
    public List<Product> trierProduitsParOrdreAlphabetique() {
        return productDao.trierList();
    }

    @GetMapping( value = "/Produits/Prix/{prix}" )
    public Product validationPrixVente( @PathVariable int prix ) {

        Product produit = productDao.findByPrix( prix );

        if ( produit == null )
            throw new ProduitGratuitException(
                    "Il n'y a aucun produit de la valeur de " + prix );
